...
const locationMapper = new Mappers.LocationMapper(Domain.locationFactory);
...
export const locationsRepo: Ports.LocationsRepo = new Adapters.PrismaLocationsRepo(locationMapper);
